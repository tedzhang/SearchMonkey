...
static inline int doublec(int j)
{  
	if (j < k0+1) 
		return	FALSE;
	if (b[j] !=	b[j-1])	
...
static inline void	setto(char * s)
{  
	int length =	s[0];
